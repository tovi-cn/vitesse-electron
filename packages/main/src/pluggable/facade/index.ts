 ...
 */
export function install(spec: string, options: object, activate: boolean) { return ipcRenderer.invoke('pluggable:install', spec, options, activate) }
 ...
 */
export function uninstall(name:string) { return ipcRenderer.invoke('pluggable:uninstall', name) }
 ...
 * @alias facade.update
 */
export function update(name:string) { return ipcRenderer.invoke('pluggable:update', name) }
 ...
 */
export function toggleActive(plugin:string, active:boolean) { return ipcRenderer.invoke('pluggable:togglePluginActive', plugin, active) }
