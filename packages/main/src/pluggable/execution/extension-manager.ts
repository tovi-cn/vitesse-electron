 ...
 */
export function add(name: string, ep?: object | any) {
 ...
 */
export function register(name: string, extension: string, response: any, priority: number) {
 ...
 */
export function executeSerial(name: any, input: any) {
